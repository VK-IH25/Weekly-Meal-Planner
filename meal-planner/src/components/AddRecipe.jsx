...
function AddRecipe(props) {
    ...
    return (
        <>
        <Title order={3} mb="20px">Add new recipe</Title>
        <form onSubmit={handleSubmit}>
            ...
            <Select
                ...
                data={["Beef", "Chicken", "Dessert", "Miscellaneous", "Pork", "Pasta", "Starter", "Vegetarian", "Vegan"]}
                value={strCategory}
            ...
            />
            <Button type="submit" mt="md">Add Recipe</Button>
            </form>
